        ...
        switch (v.getId()) {
            ...
            case R.id.btnToggleUppercase:
                ...
                if (isUppercaseEnabled)
                    btnToggleUppercase.setText(getResources().getString(R.string.disable_uppercase));
                else
                    btnToggleUppercase.setText(getResources().getString(R.string.enable_uppercase));
